...
import sqlsolver.fragment.AggFuncKind;
import sqlsolver.util.SetMatching;

import java.util.*;

import static sqlsolver.common.ArraySupport.concat;
import static sqlsolver.uexpr.UVar.VarKind.BASE;
import static sqlsolver.uexpr.UVar.VarKind.PROJ;
...
public interface UVar extends Copyable<UVar> {
  ...
  default boolean is(VarKind kind) {
    return kind() == kind;
  }
