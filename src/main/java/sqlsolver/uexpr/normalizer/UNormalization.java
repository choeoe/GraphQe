package sqlsolver.uexpr.normalizer;
...
import static sqlsolver.common.IterableSupport.*;
import static sqlsolver.common.ListSupport.concat;
...
//U1: [#1(t) = ∑{x1,x3,x4}(([#0(t) = 11] * [SAL(x1) < 11] + [#0(t) = -1 * SAL(x1)] * not([SAL(x1) < 11])))] * ([#0(t) = 11] * [SAL(x1) < 11] + [#0(t) = -1 * SAL(x1)] * not([SAL(x1) < 11]))
//U2: [#1(t) = ∑{x1,x2,x3}(([#0(t) = 11] * [SAL(x3) < 11] + [#0(t) = -1 * SAL(x3)] * not([SAL(x3) < 11])))] * ([#0(t) = 11] * [SAL(x3) < 11] + [#0(t) = -1 * SAL(x3)] * not([SAL(x3) < 11]))
